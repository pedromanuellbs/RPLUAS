<html>
  ...
  <body>
    <div class="w-full h-screen flex flex-col relative">
      ...
      <!-- Menu Section -->
      <div class="w-full bg-transparent h-[96px] flex flex-row items-center z-10">
        ...
        <div class="w-1/3 flex items-center justify-center">
          <a href="/" class="group"><span class="font-bold text-5xl font-quicksand text-white group-hover:text-develobe-500 duration-200">SINEMA PINPINCE</span></a>
        </div>
      ...
      $circumference = 2 * 32 * 22 / 7; // 2 * phi * r . r = 32 pixel sesuai dengan komponen yang akan dibuat
      ...
      <div class="w-full h-full z-10 flex flex-col justify-center px-20">
        ...
        @if($trailerID)
        <button class="w-fit bg-develobe-500 text-white pl-4 pr-6 py-3 mt-5 font-inter text-xl flex flex-row rounded-lg items-center hover:drop-shadow-lg duration-200" onclick="showTrailer(true)">
      ...
      <div id="trailerWrapper" class="absolute z-10 w-full h-screen p-20 bg-black flex flex-col">
        ...
        <iframe id="youtubeVideo" class="w-full h-full" src="https://www.youtube.com/embed/{{$trailerID}}?enablejsapi=1" title="{{ $tvData->name }}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
      @endif
